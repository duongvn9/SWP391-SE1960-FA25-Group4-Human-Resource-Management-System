...
/**
 * DAO class cho Department entity Xử lý các thao tác CRUD với bảng departments
 */
public class DepartmentDao {
    ...
    public Department create(Department department) {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(INSERT_DEPARTMENT, Statement.RETURN_GENERATED_KEYS)) {
    ...
    public Department update(Department department) {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(UPDATE_DEPARTMENT)) {
    ...
    public boolean delete(Long departmentId) {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(DELETE_DEPARTMENT)) {
    ...
    public Optional<Department> findById(Long departmentId) {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(SELECT_DEPARTMENT_BY_ID)) {
    ...
    public Optional<Department> findByName(String name) {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(SELECT_DEPARTMENT_BY_NAME)) {
    ...
    public List<Department> findAll() {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(SELECT_ALL_DEPARTMENTS); ResultSet rs = stmt.executeQuery()) {
    ...
    public List<Department> findByHeadAccountId(Long headAccountId) {
        ...
        try (Connection conn = DatabaseUtil.getConnection(); PreparedStatement stmt = conn.prepareStatement(SELECT_DEPARTMENTS_BY_HEAD)) {
