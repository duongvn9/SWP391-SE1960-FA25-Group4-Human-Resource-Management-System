                ...
                printWindow.onload = function() {
                    ...
                    if (grossAmount === 'N/A') {
                        ...
                        if (allAmounts && allAmounts.length > 0) {
                            ...
                            if (maxAmountStr) grossAmount = maxAmountStr;
                        }
                    }
                        ...
                        if (summarySection) {
                            ...
                            if (grossRow) {
                                ...
                                if (parent) {
                                    ...
                                    if (amountCell) amountCell.textContent = grossAmount;
                                }
                            }
                            ...
                            if (deductRow) {
                                ...
                                if (parent) {
                                    const amountCell = parent.querySelector('.text-end, strong');
                                    if (amountCell) amountCell.textContent = '-' + deductionsAmount;
                                }
                            }
                            
                            // Update Net Salary card
                            const netCard = summarySection.querySelector('h3');
                            if (netCard) netCard.textContent = netAmount;
                        }
                    }
