...
<head>
    <jsp:include page="../layout/head.jsp">
        <jsp:param name="pageTitle" value="My Requests - HRMS (OLD)" />
...
<body>
    ...
    <div class="main-content" id="main-content">
        ...
        <div class="content-area">
            <div class="row mb-4">
                <div class="col-12">
                    <h2><i class="fas fa-clipboard-list me-2"></i>My Requests (OLD VERSION)</h2>
            ...
            <div class="filter-section">
                <form method="get" action="${pageContext.request.contextPath}/requests/list/old" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-12">
                        ...
                        <a href="${pageContext.request.contextPath}/requests/list/old" class="btn btn-secondary">
