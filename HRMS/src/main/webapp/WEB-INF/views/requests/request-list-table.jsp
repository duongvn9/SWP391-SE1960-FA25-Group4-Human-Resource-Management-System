                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <!-- Approve Button (has approval permission and status is PENDING) -->
                                    <c:if test="${req.canApprove && req.status == 'PENDING'}">
                    ...
                    <div class="request-card">
                        ...
                        <div class="request-card-footer">
                            <div class="request-card-actions">
                                <a href="${req.detailUrl}" class="btn btn-sm btn-outline-info">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <c:if test="${req.canApprove && req.status == 'PENDING'}">
                                    <button onclick="openApprovalModal(${req.id}, '${req.title}')" class="btn btn-sm btn-warning">
                                        <i class="fas fa-clipboard-check"></i>
                                    </button>
                                </c:if>
                            </div>
        ...
        <c:otherwise>
            ...
            <div class="empty-state text-center py-5">
                ...
                <p class="text-muted mb-4">
                    <c:choose>
                        <c:when test="${not empty filter.searchKeyword || not empty filter.status || not empty filter.requestTypeId}">
                        ...
                        <c:otherwise>
                            You haven't created any requests yet. Get started by creating your first request.
                        </c:otherwise>
                    </c:choose>
                </p>
                <div class="d-flex gap-2 justify-content-center flex-wrap">
                    ...
                    <c:if test="${not empty filter.searchKeyword || not empty filter.status || not empty filter.requestTypeId || not empty filter.fromDate || not empty filter.toDate}">
