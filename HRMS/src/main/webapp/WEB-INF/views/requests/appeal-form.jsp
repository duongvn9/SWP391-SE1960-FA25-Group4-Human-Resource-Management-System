        ...
        <body>
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/requests/appeal/create"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="attachmentType"
                                                id="attachmentTypeLink" value="link" ${attachmentType=='link'
                                                ? 'checked' : '' }>
            ...
            <script>
                ...
                function updateWordCountInline(textarea) {
                    console.log("updateWordCountInline called"); // Debug

                    const text = textarea.value;
                    const words = text.trim() === "" ? 0 : text.trim().split(/\s+/).length;
                    const maxWords = 200;

                    console.log("Text:", text, "Words:", words); // Debug

                    const display = document.getElementById("wordCount");
                    const error = document.getElementById("wordLimitError");

                    console.log("Display element:", display); // Debug

                    if (display) {
                        display.textContent = words + "/" + maxWords + " words";
                        console.log("Updated display to:", display.textContent); // Debug
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (textarea) {
                        ...
                        // Backup: Update every second for first 10 seconds
                        let counter = 0;
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    console.log("Word count script loaded"); // Debug log
                    ...
                    function updateWordCount() {
                        ...
                        console.log("Updating word count:", wordCount); // Debug log
                    ...
                    setTimeout(function () {
                        updateWordCount();
                        console.log("Initial word count set"); // Debug log
                    }, 100);

                    // Backup: Force update every 500ms for first 5 seconds (in case of issues)
                    let backupCounter = 0;
