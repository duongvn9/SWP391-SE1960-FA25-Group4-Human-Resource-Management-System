...
<html>
    <head>
        <jsp:include page="../layout/head.jsp">
            ...
            <jsp:param name="pageCss" value="appeal-form.css" />
        </jsp:include>
        <style>
            /* Overlay cho popup */
            #selectRecordPopup {
            ...
            <div class="content-area">
                ...
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Submit Attendance Dispute</li>
                    </ol>
                </nav>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/requests/appeal/create"
                            ...
                            <div class="mb-3">
                                ...
                                <c:if test="${not empty records}">
                                    <div id="selectedRecordsList" class="selected-records-container mt-3">
                                        <c:forEach var="rec" items="${records}">
                                            <div class="record-item">
                                                <!-- Nút xóa bản ghi -->
                                                <button type="button" class="remove-record-btn"
                                                        data-userid="${rec.userId}" title="Remove Record">×</button>
                            ...
                            <div class="mt-4 d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="submit" class="btn btn-appeal-primary">
                ...
                <div class="popup-content">
                    ...
                    <form id="attendanceForm" method="post" action="${pageContext.request.contextPath}/requests/appeal/create">
                        ...
                        <div class="popup-actions mt-3 d-flex justify-content-end gap-2">
                            <button type="submit" id="submitSelectedRecords" class="btn btn-appeal-primary">Submit</button>
                            <button type="button" id="closePopupBtn2" class="btn btn-appeal-secondary">Close</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                form.addEventListener("submit", function (e) {
                    ...
                    if (!recordsDiv || recordsDiv.children.length === 0) {
                        ...
                        recordsDiv?.scrollIntoView({behavior: "smooth"});
                    } else {
                    ...
                    const records = [];
                    if (recordsDiv) {
                        const recordItems = recordsDiv.querySelectorAll(".record-item");
                ...
                // Hide error when clicking select button
                ...
                document.querySelectorAll('.remove-record-btn').forEach(btn => {
                    btn.addEventListener('click', e => {
                        const parentDiv = e.target.closest('.record-item');
