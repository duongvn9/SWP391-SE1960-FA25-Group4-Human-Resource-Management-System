                    ...
                    <div class="popup-content">
                        ...
                        <form id="attendanceForm" method="post"
                            ...
                            <div class="popup-actions mt-3 d-flex justify-content-end gap-2">
                                <button type="submit" id="submitSelectedRecords"
                                    class="btn btn-appeal-primary">Submit</button>
                                <button type="button" id="closePopupBtn2"
                                    class="btn btn-appeal-secondary">Close</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    removeBtns.forEach(btn => {
                        btn.addEventListener("click", function () {
                            const div = btn.closest(".record-item");
                            if (div)
                                div.remove();
                        });
                    });
