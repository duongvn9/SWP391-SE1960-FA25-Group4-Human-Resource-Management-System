<%-- 
    Document : drafts.jsp (Hiển thị danh sách nháp Manager)
    Mục đích : Hiển thị Job Summary (từ JSON) thay vì trường description đã lỗi thời.
--%>
                            ...
                                        <div class="card-body">
                                ...
                                                <table class="table table-hover align-middle">
                                                      <thead class="table-light">
                                                            <tr>
                                                                  <th>Title</th>
                                                                  <th>Job Summary</th>                       <th>Created At</th>
                                                                  <th>Actions</th>
                                                                </tr>
                                                          </thead>
                                                      <tbody>
                                                            <c:forEach var="draft" items="${draftList}">
                                                                  <tr>
                                                                        <td>${draft.title}</td>
                                                                                                <td>
                                                    <c:if test="${draft.recruitmentDetails != null}">
                                                        ${draft.recruitmentDetails.jobSummary}
                                                    </c:if>
                                                </td>
                                                                        <td>${draft.createdAt}</td>
                                                                        <td>
                                                                              <a href="${pageContext.request.contextPath}/requests/recruitment/${draft.id}/edit"
