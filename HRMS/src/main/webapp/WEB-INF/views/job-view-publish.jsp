                ...
                <%-- Function to format job type --%>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <c:set var="formattedJobType"
                                value="${fn:toUpperCase(fn:substring(formattedJobType, 0, 1))}${fn:substring(formattedJobType, 1, -1)}" />
                        </c:otherwise>
                    </c:choose>
                    ...
                    <%-- Function to format job level --%>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <c:set var="formattedLevel"
                                    value="${fn:toUpperCase(fn:substring(formattedLevel, 0, 1))}${fn:substring(formattedLevel, 1, -1)}" />
                            </c:otherwise>
                        </c:choose>
                        ...
                        <%-- Function to format salary --%>
                            ...
                            <c:choose>
                                <c:when test="${not empty job.minSalary && not empty job.maxSalary}">
                                    <fmt:formatNumber value="${job.minSalary}" pattern="#,###"
                                        var="minSalaryFormatted" />
                                    <fmt:formatNumber value="${job.maxSalary}" pattern="#,###"
                                        var="maxSalaryFormatted" />
                                    <c:set var="formattedSalaryRange"
                                        value="${minSalaryFormatted} - ${maxSalaryFormatted} VND" />
                                </c:when>
                                                ...
                                                <div class="job-hero-content" data-aos="fade-right">
                                                    ...
                                                    <div class="job-hero-meta">
                                                        <div class="job-meta-item">
                                                            ...
                                                            <span>
                                                                <c:out
                                                                    value="${department != null ? department.name : 'Department'}" />
                                                            </span>
                                                        </div>
                                                        <div class="job-meta-item">
                                                            ...
                                                            <span>
                                                                <c:out
                                                                    value="${empty job.workingLocation ? 'Office Location' : job.workingLocation}" />
                                                            </span>
                                                        </div>
                                                        <div class="job-meta-item">
                                                            <i class="fas fa-clock"></i>
                                                            <span>
                                                                <c:out value="${formattedJobType}" />
                                                            </span>
                                                        </div>
                                                        <div class="job-meta-item">
                                                            <i class="fas fa-layer-group"></i>
                                                            <span>
                                                                <c:out value="${formattedLevel}" />
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="job-hero-badges">
                                                        ...
                                                        <c:if test="${job.numberOfPositions > 1}">
                                                            <span
                                                                class="job-hero-badge job-positions">${job.numberOfPositions}
                                                                positions</span>
                                                        </c:if>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="job-content-card" data-aos="fade-up">
                                                    ...
                                                    <div class="content-section">
                                                        ...
                                                        <div class="section-content">
                                                            <p><strong>FPT Smart Cloud (FCI)</strong> – a member of FPT
                                                                Corporation, pioneers AI & Cloud solutions in Vietnam.
                                                                FCI was founded with the mission to generate an immense
                                                                leap in productivity and agility in business operations.
                                                            </p>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="work-details">
                                                                ...
                                                                <div class="work-detail-item">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span>
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${not empty job.startDate}">
                                                                                    <c:set var="startDateStr"
                                                                                        value="${job.startDate.toString()}" />
                                                                                    <fmt:parseDate
                                                                                        value="${startDateStr}"
                                                                                        pattern="yyyy-MM-dd"
                                                                                        var="parsedStartDate" />
                                                                ...
                                                                <div class="work-detail-item">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span>
                                                                            <c:out
                                                                                value="${empty job.workingHours ? 'Standard office hours' : job.workingHours}" />
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div class="work-detail-item">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span>
                                                                            <c:out value="${job.numberOfPositions}" />
                                                                            position<c:if
                                                                                test="${job.numberOfPositions > 1}">s
                                                                            </c:if>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="contact-item">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <a href="mailto:${job.contactEmail}">
                                                                            <c:out
                                                                                value="${empty job.contactEmail ? 'hr@company.com' : job.contactEmail}" />
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="contact-item">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <a href="tel:${job.contactPhone}">
                                                                            <c:out
                                                                                value="${empty job.contactPhone ? '+84 123 456 789' : job.contactPhone}" />
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="apply-section">
                                                        <button class="btn btn-apply"
                                                            onclick="showApplicationModal('${job.id}', '${fn:escapeXml(job.title)}')"
                                                                <i class="fas fa-paper-plane me-2"></i>Apply Now
                                                            </button>
                                                            <p class="apply-note">Ready to join our team? Send us your
                                                                CV and let's start the conversation!</p>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="quick-info">
                                                                ...
                                                                <div class="info-item">
                                                                    ...
                                                                    <span class="info-value deadline">
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${not empty job.applicationDeadline}">
                                                                                <c:set var="deadlineStr"
                                                                                    value="${job.applicationDeadline.toString()}" />
                                                                                <fmt:parseDate value="${deadlineStr}"
                                                                                    pattern="yyyy-MM-dd"
                                                                                    var="parsedDeadline" />
                                                                                <fmt:formatDate
                                                        ...
                                                        <div class="sidebar-card">
                                                            ...
                                                            <div class="related-jobs">
                                                                <a href="${pageContext.request.contextPath}/jobs"
                                                                    ...
                                                                    <i class="fas fa-arrow-right me-2"></i>View All Open
                                                                    Positions
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <form id="applicationForm" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-section">
                                                            <h6 class="section-title">
                                                                <i class="fas fa-id-card me-2"></i>Citizen ID (CCCD)
                                                                Information <span class="text-danger">*</span>
                                                            </h6>
                                                            <div class="mb-3">
                                                                <label for="cccdFrontUpload" class="form-label">Upload
                                                                    CCCD Front Image <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="file" class="form-control"
                                                                    id="cccdFrontUpload" name="cccdFrontUpload"
                                                                    accept="image/jpeg,image/jpg,image/png" required>
                                                                <div class="form-text">
                                                                    <strong>Please upload the front side of your
                                                                        Vietnamese Citizen ID Card (CCCD) first, then
                                                                        click "Extract Information" to automatically
                                                                        fill the form fields below.</strong><br>
                                                                    Supported formats: JPG, PNG (Max size: 10MB)
                                                                </div>
                                                                <button type="button"
                                                                    class="btn btn-primary btn-sm mt-2"
                                                                    id="processOCRBtn" disabled>
                                                                    <i class="fas fa-magic me-1"></i>Extract Information
                                                                </button>
                                                                <div id="ocrStatus" class="mt-2" style="display: none;">
                                                                    <div class="alert alert-info">
                                                                        <i
                                                                            class="fas fa-spinner fa-spin me-2"></i>Processing
                                                                        CCCD image...
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="cccd" class="form-label">CCCD Number <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" id="cccd"
                                                                    name="cccd" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="cccdName" class="form-label">Full Name from
                                                                    CCCD <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" id="cccdName"
                                                                    name="cccdName" required>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="cccdDob" class="form-label">Date of
                                                                        Birth <span class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control" id="cccdDob"
                                                                        name="cccdDob" placeholder="DD/MM/YYYY"
                                                                        required>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="cccdGender" class="form-label">Gender
                                                                        <span class="text-danger">*</span></label>
                                                                    <select class="form-select" id="cccdGender"
                                                                        name="cccdGender" required>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="cccdHometown"
                                                                    class="form-label">Hometown/Origin <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    id="cccdHometown" name="cccdHometown" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-section">
                                                            <h6 class="section-title">
                                                                <i class="fas fa-file-alt me-2"></i>Resume/CV <span
                                                                    class="text-danger">*</span>
                                                            </h6>
                                                            <div class="mb-3">
                                                                <label for="resumeUrl" class="form-label">Resume/CV Link
                                                                    <span class="text-danger">*</span></label>
                                                                <input type="url" class="form-control" id="resumeUrl"
                                                                    name="resumeUrl"
                                                                    placeholder="https://drive.google.com/... or https://linkedin.com/..."
                                                                    required>
                                                                <div class="form-text">Provide a link to your online
                                                                    resume (Google Drive, LinkedIn, etc.)</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-section">
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label" for="agreeTerms">
                                                                    ...
                                                                    and complete <span class="text-danger">*</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </form>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body text-center py-4">
                                                    ...
                                                    <p class="text-muted mb-4">Thank you for your interest in this
                                                        position. We have received your application with CCCD
                                                        information and will review it shortly. You will hear from us
