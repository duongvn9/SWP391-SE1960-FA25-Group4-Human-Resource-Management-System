                    ...
                    <div class="job-hero-content" data-aos="fade-right">
                        ...
                        <div class="job-hero-meta">
                            <div class="job-meta-item">
                                ...
                                <span>
                                    <c:out value="${department != null ? department.name : 'Department'}" />
                                </span>
                            </div>
                            <div class="job-meta-item">
                                <i class="fas fa-map-marker-alt"></i>
                                <span>
                                    <c:out value="${empty job.workingLocation ? 'Office Location' : job.workingLocation}" />
                                </span>
                            </div>
                            <div class="job-meta-item">
                                ...
                                <div class="work-details">
                                    ...
                                    <div class="work-detail-item">
                                        ...
                                        <div>
                                            ...
                                            <span>
                                                <c:out value="${empty job.workingHours ? 'Standard office hours' : job.workingHours}" />
                                            </span>
                                        </div>
                                    </div>
                                    <div class="work-detail-item">
                                        ...
                                        <div>
                                            ...
                                            <span>
                                                <c:out value="${job.numberOfPositions}" /> position<c:if test="${job.numberOfPositions > 1}">s</c:if>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-item">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:${job.contactEmail}">
                                                <c:out value="${empty job.contactEmail ? 'hr@company.com' : job.contactEmail}" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="contact-item">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:${job.contactPhone}">
                                                <c:out value="${empty job.contactPhone ? '+84 123 456 789' : job.contactPhone}" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form id="applicationForm" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="cccdFrontUpload" name="cccdFrontUpload" accept="image/jpeg,image/jpg,image/png" required>
                                <div class="form-text">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cccdDob" name="cccdDob" placeholder="DD/MM/YYYY" required>
                                </div>
                                <div class="col-md-6 mb-3">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" id="resumeUrl" name="resumeUrl" placeholder="https://drive.google.com/... or https://linkedin.com/..." required>
