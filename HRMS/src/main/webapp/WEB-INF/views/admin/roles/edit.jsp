...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <!-- Form -->
            <form method="post" action="${pageContext.request.contextPath}/admin/roles/edit">
                <!-- CSRF Token -->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control readonly-field" id="id" 
                ...
                <div class="mb-4">
                    ...
                    <input type="number" class="form-control" id="priority" name="priority" 
                           value="${role.priority}" min="0" max="100">
                    <div class="form-text">
                        Higher priority roles have more authority.
                    </div>
                </div>
