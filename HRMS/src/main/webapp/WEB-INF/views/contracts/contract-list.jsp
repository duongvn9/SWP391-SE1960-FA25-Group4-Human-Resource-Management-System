                    ...
                    <c:if test="${not empty usersWithoutContract}">
                        <div class="alert alert-info" role="alert">
                            <div class="clickable-header" style="cursor: pointer;" data-bs-toggle="collapse"
                                ...
                                <p class="mb-0 small">The following users don't have contracts yet. Click on a user to create a contract.</p>
                            </div>
                            <div class="collapse mt-2" id="usersWithoutContractCollapse">
                                    ...
                                    <c:forEach var="user" items="${usersWithoutContract}" varStatus="status">
                                        <c:if test="${status.index < 10}">
                                            <div class="col-md-6 col-lg-4">
                                                <div class="card create-contract-card" style="cursor: pointer; transition: all 0.3s ease; border: 2px solid #667eea;"
                                                    ...
                                                    <div class="card-body p-2">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-2">
                                                                ...
                                                                <small class="text-muted">${user.employeeCode}</small>
                                                                <c:if test="${not empty user.departmentName}">
                                                                    <br><small class="text-muted">${user.departmentName} - ${user.positionName}</small>
                                                                </c:if>
                                                            </div>
                                                            <div class="flex-shrink-0">
                                ...
                                <c:if test="${usersWithoutContractTotal > 10}">
                                    <div class="text-center mt-2">
                                        <small class="text-muted">Showing 10 of ${usersWithoutContractTotal} users without contract.</small>
                                    </div>
                                </c:if>
                            </div>
                        </div>
                            ...
                            <form method="get" action="${pageContext.request.contextPath}/contracts" class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="approvalStatus" name="approvalStatus">
                                        <option value="all" ${empty approvalStatusFilter || approvalStatusFilter=='all' ? 'selected' : '' }>All</option>
                                        <option value="pending" ${approvalStatusFilter=='pending' ? 'selected' : '' }>Pending Approval</option>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <option value="all" ${empty statusFilter || statusFilter=='all' ? 'selected' : '' }>All</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="type" name="type">
                                        ...
                                        <option value="indefinite" ${typeFilter=='indefinite' ? 'selected' : '' }>
                                            Indefinite</option>
                                        <option value="fixed_term" ${typeFilter=='fixed_term' ? 'selected' : '' }>Fixed
                                            Term</option>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${contract.approvalStatus == 'rejected'}">
                                                                ...
                                                                <c:if test="${not empty contract.rejectedReason}">
                                                                    <br><small class="text-danger" title="${contract.rejectedReason}">
                                                                        <i class="fas fa-info-circle"></i> ${contract.rejectedReason}
                                                                    </small>
                                                                </c:if>
                                                            </c:when>
                                                            <c:otherwise>
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-info" title="View Details"
                                                                onclick="showContractDetail(
                                                                    ...
                                                                    '${contract.formattedSalary}',
                                                                    '${contract.currency}',
                                                                    '${contract.note != null ? contract.note : ""}',
                                                                    '${contract.rejectedReason != null ? contract.rejectedReason : ""}',
                                                                    '${contract.createdByName != null ? contract.createdByName : "N/A"}',
                                                                    '${contract.formattedCreatedAt != null ? contract.formattedCreatedAt : "N/A"}',
                                                                    '${contract.approvedByName != null ? contract.approvedByName : ""}',
                                                                    '${contract.formattedApprovedAt != null ? contract.formattedApprovedAt : ""}'
                                                                )">
                                                                <i class="fas fa-eye"></i>
                                                            </button>
                                                            
                                                            <!-- HRM Actions: Approve/Reject for PENDING approval_status -->
                                                            <c:if test="${sessionScope.user.positionId == 7 && contract.approvalStatus == 'pending'}">
                                                                <button type="button" class="btn btn-sm btn-success" 
                                                                    onclick="showApproveModal(${contract.id}, '${contract.contractNo}')" title="Approve">
                                                                    <i class="fas fa-check"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-sm btn-danger" 
                                                                    onclick="showRejectModal(${contract.id}, '${contract.contractNo}')" title="Reject">
                                                                    <i class="fas fa-times"></i>
                                                                </button>
                                                            </c:if>
                                                            
                                                            <!-- HR Actions: Edit for PENDING or REJECTED approval_status -->
                                                            <c:if test="${sessionScope.user.positionId == 8 && (contract.approvalStatus == 'pending' || contract.approvalStatus == 'rejected')}">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="approveForm" method="post" action="${pageContext.request.contextPath}/contracts/approve">
                            <div class="modal-body">
                                ...
                                <p>Are you sure you want to approve contract <strong id="approveContractNo"></strong>?</p>
                                <p class="text-success"><i class="fas fa-check-circle"></i> This contract will be approved and ready for activation.</p>
                            </div>
                            <div class="modal-footer">
            ...
            <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="rejectForm" method="post" action="${pageContext.request.contextPath}/contracts/reject">
                            <div class="modal-body">
                                <input type="hidden" name="csrfToken" value="${csrfToken}">
                                <input type="hidden" name="id" id="rejectContractId">
                                <p>Are you sure you want to reject contract <strong id="rejectContractNo"></strong>?</p>
                                <div class="mb-3">
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="deleteForm" method="post" action="${pageContext.request.contextPath}/contracts/delete">
                            <div class="modal-body">
                                <input type="hidden" name="csrfToken" value="${csrfToken}">
                                <input type="hidden" name="id" id="deleteContractId">
                                <p>Are you sure you want to delete contract <strong id="deleteContractNo"></strong>?</p>
